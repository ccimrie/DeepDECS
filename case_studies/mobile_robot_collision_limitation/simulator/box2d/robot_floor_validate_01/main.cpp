...
int main(int argc, char** argv)
{
        ...
        for(int i=1; i<path.size(); ++i)
        {
            ...
            while (!travel)
            {
                ...
                if(unif_p(rng)<p_cldr_presence)
                {
                    ...
                    //  V2
                    // if (label==1 && v1==0) p_x=x0;
                    // else if (label==1 && v1==1) p_x=x1;
                    // else if (label==0 && v1==0) p_x=x2;
                    // else if (label==0 && v1==1) p_x=x3;
    ...
    // V2
    std::string filename=outfile_path+"/simulate_v2_"+std::to_string(visit)+".txt";
