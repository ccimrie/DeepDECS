...
int main(int argc, char** argv)
{
    ...
    std::string outfile_path(argv[16]);
    ...
    // V1+V2
    std::string filename=outfile_path+"/simulate_v1_v2_"+std::to_string(visit)+".txt";
    ...
    outfile << x0 << " " << x1 << " " << x2 << " " << x3 << " " << x4 << " " << x5 << " " << x6 << " " << x7 << " " << time_avg << " " << time_stdev << " " << 1-risk_avg << " " << risk_stdev<<std::endl;
