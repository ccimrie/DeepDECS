...
int main(int argc, char** argv)
{
    ...
    std::string outfile_path(argv[10]);
    ...
    // No verification 
    std::string filename=outfile_path+"/simulate_no_verify_"+std::to_string(visit)+".txt";
    // outfile.open(path+std::to_string()+".txt", std::ios_base::app);
    ...
    outfile << x0 << " " << x1 << " " << time_avg << " " << time_stdev << " " << 1-risk_avg << " " << risk_stdev<<std::endl;    
